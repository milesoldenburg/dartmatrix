...
/**
 * Returns the point value of the SVG id
 * @pram id
 * @returns {integer} the point value
 */
var getPointValueOfId = function(id){
    if (_.isNull(id)) {
        return 0;
...
/**
 * Returns the amount, category, base point value, short hand display name, and point value of the SVG id.
 * @param id
 * @returns {object} an object containing amount, category, basePoints, display, and points fields
 */
var getDartDataOfId = function(id){
    var amount;
    var category;
    var basePoints;
    var display;
    ...
    if (_.isNull(id)) {
        ...
        basePoints = parseInt(category);
        display = 'D-' + category;
    } else if (id.charAt(0) === 'o') {
        amount = 1;
        category = id.substr(2);
        basePoints = parseInt(category);
        display = category;
    } else if (id.charAt(0) === 't') {
        amount = 3;
...
var setAccuracy = function(_accuracy){
    accuracy = _accuracy;
};

module.exports = {
    'getDartDataOfId' : getDartDataOfId,
    'getHit' : getHit,
