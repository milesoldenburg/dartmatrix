...
/**
 * Returns the amount, category, base point value, and point value of the SVG id.
 * @param id
 * @returns {object} an object containing amount, category, basePoints, and points fields
 */
var getDartDataOfId = function(id){
    var amount = 1;
    var points = getPointValueOfId(id);
    var category = 'Miss';
    var basePoints = 0;
